...
for sensor in senList:
    ...
    for folderName in dirList:
        ...
        for trial in range(1,4):
            ...
            if sensor == 'Strain_Gauge':
                ...
                plt.figure(figsize = (14, 7))
                plt.plot(time, voltage, label = 'Voice Coil Output')
                plt.title('Voice Coil Trial {}'.format(trial))
                plt.rcParams.update({'font.size': 18})
                plt.xlabel('Time (s)')
                plt.ylabel('Voltage (v)')
                plt.grid(which = 'both')
                plt.legend()
                plt.savefig('VVsTime {}.png'.format(trial))
                plt.close()
    ...
    if sensor == 'Strain_Gauge' or sensor == 'IR' or sensor == 'Accelerometer':
        ...
        if sensor == 'Strain_Gauge' or sensor == 'IR':
            ...
            report[sensor]['StErrS'] = sum(power(flatResS, 2)/(len(flatResS)-2))
            report[sensor]['SS_S'] = sum(power(flatXS - mean(flatXS), 2))
            report[sensor]['95%CIS'] = [1.96*sqrt(report[sensor]['StErrS']/report[sensor]['SS_S']), sqrt(report[sensor]['StErrS']*(1/len(flatXS) + mean(flatXS)/report[sensor]['SS_S']))]
    ...
    report[sensor]['StErrD'] = sum(power(flatResD, 2)/(len(flatResD)-2))
    report[sensor]['SS_D'] =  sum(power(flatXD - mean(flatXD), 2))
    report[sensor]['95%CID'] = [1.96*sqrt(report[sensor]['StErrD']/report[sensor]['SS_D']), sqrt(report[sensor]['StErrD']*(1/len(flatXD) + power(mean(flatXD), 2)/report[sensor]['SS_D']))]
    ...
    if sensor == 'Strain_Gauge':
        ...
        plt.grid(b = True, which = 'both')
        plt.legend(fontsize =  12)
        plt.savefig('Static_Behavior_Residual_{}.png'.format(sensor), bbox_inches = 'tight', transparent = True)
        # plt.show()
        plt.close()
        ...
        plt.grid(b = True, which = 'both')
        plt.legend(fontsize =  12)
        plt.savefig('Dynamic_Behavior_Residual_{}.png'.format(sensor), bbox_inches = 'tight', transparent = True)
        # plt.show()
        plt.close()

        # print(confBand(flatXS, report[sensor]['StErrS'], report[sensor]['SS_S'], 50000, 1.96))
        print('Static Coefficients are {}'.format(report[sensor]['Static_Model']))
        ...
        plt.plot(flatXS, sg(flatXS, report[sensor]['Static_Model'][0], report[sensor]['Static_Model'][1]) + confBand(flatXS, report[sensor]['StErrS'], report[sensor]['SS_S'], len(flatXS), 1.96), 'r--',label = '95% Confidence Interval Upper Limit ')
        plt.plot(flatXS, sg(flatXS, report[sensor]['Static_Model'][0], report[sensor]['Static_Model'][1]) - confBand(flatXS, report[sensor]['StErrS'], report[sensor]['SS_S'], len(flatXS), 1.96), 'r--',label = '95% Confidence Interval Lower Limit ')
        ...
        plt.grid(b = True, which = 'both')
        plt.legend(fontsize =  12)
        plt.savefig('Static_Behavior_Model_{}.png'.format(sensor), bbox_inches = 'tight', transparent = True)
        # plt.show()
        plt.close()

        # print(confBand(flatXD, report[sensor]['StErrD'], report[sensor]['SS_D'], 50000, 1.96))
        print('Dynamic Coefficients are {}'.format(report[sensor]['Dynamic_Model']))
        ...
        plt.plot(flatXD, sg(flatXD, report[sensor]['Dynamic_Model'][0], report[sensor]['Dynamic_Model'][1]) + confBand(flatXD, report[sensor]['StErrD'], report[sensor]['SS_D'], len(flatXD), 1.96), 'r--',label = '95% Confidence Interval Upper Limit ')
        plt.plot(flatXD, sg(flatXD, report[sensor]['Dynamic_Model'][0], report[sensor]['Dynamic_Model'][1]) - confBand(flatXD, report[sensor]['StErrD'], report[sensor]['SS_D'], len(flatXD), 1.96), 'r--',label = '95% Confidence Interval Lower Limit ')
        ...
        plt.grid(b = True, which = 'both')
        plt.legend(fontsize =  12)
        plt.savefig('Dynamic_Behavior_Model_{}.png'.format(sensor), bbox_inches = 'tight', transparent = True)
        # plt.show()
        plt.close()
        ...
        plt.plot(flatXS, ir(flatXS, report[sensor]['Static_Model'][0], report[sensor]['Static_Model'][1]) + confBand(flatXS, report[sensor]['StErrS'], report[sensor]['SS_S'], len(flatXS), 1.96), 'r--',label = '95% Confidence Interval Upper Limit ')
        plt.plot(flatXS, ir(flatXS, report[sensor]['Static_Model'][0], report[sensor]['Static_Model'][1]) - confBand(flatXS, report[sensor]['StErrS'], report[sensor]['SS_S'], len(flatXS), 1.96), 'r--',label = '95% Confidence Interval Lower Limit ')
        plt.plot(report[sensor]['xDataS'][0], report[sensor]['yDataS'][0], 'b,', label = 'Trial 1 : Quasi-Transient')
        plt.plot(report[sensor]['xDataS'][1], report[sensor]['yDataS'][1], 'b,', label = 'Trial 2 : Quasi-Transient')
        plt.plot(report[sensor]['xDataS'][2], report[sensor]['yDataS'][2], 'b,', label = 'Trial 3 : Quasi-Transient')
        plt.xlabel('Displacement (m)')
        ...
        plt.plot(flatXD, ir(flatXD, report[sensor]['Dynamic_Model'][0], report[sensor]['Dynamic_Model'][1]) + confBand(flatXD, report[sensor]['StErrD'], report[sensor]['SS_D'], len(flatXD), 1.96), 'r--',label = '95% Confidence Interval Upper Limit ')
        plt.plot(flatXD, ir(flatXD, report[sensor]['Dynamic_Model'][0], report[sensor]['Dynamic_Model'][1]) - confBand(flatXD, report[sensor]['StErrD'], report[sensor]['SS_D'], len(flatXD), 1.96), 'r--',label = '95% Confidence Interval Lower Limit ')
        plt.plot(report[sensor]['xDataT'][0], report[sensor]['yDataT'][0], 'b,', label = 'Trial 1 : Transient')
        plt.plot(report[sensor]['xDataT'][1], report[sensor]['yDataT'][1], 'b,', label = 'Trial 2 : Transient')
        plt.plot(report[sensor]['xDataT'][2], report[sensor]['yDataT'][2], 'b,', label = 'Trial 3 : Transient')
        ...
        plt.plot(flatXD, acc(flatXD, report[sensor]['Dynamic_Model'][0], report[sensor]['Dynamic_Model'][1]) + confBand(flatXD, report[sensor]['StErrD'], report[sensor]['SS_D'], len(flatXD), 1.96), 'r--',label = '95% Confidence Interval Upper Limit ')
        plt.plot(flatXD, acc(flatXD, report[sensor]['Dynamic_Model'][0], report[sensor]['Dynamic_Model'][1]) - confBand(flatXD, report[sensor]['StErrD'], report[sensor]['SS_D'], len(flatXD), 1.96), 'r--',label = '95% Confidence Interval Lower Limit ')
        plt.plot(report[sensor]['xDataT'][0], report[sensor]['yDataT'][0], 'b,', label = 'Trial 1 : Transient')
        plt.plot(report[sensor]['xDataT'][1], report[sensor]['yDataT'][1], 'b,', label = 'Trial 2 : Transient')
        plt.plot(report[sensor]['xDataT'][2], report[sensor]['yDataT'][2], 'b,', label = 'Trial 3 : Transient')
        ...
        plt.plot(flatXD, vc(flatXD, report[sensor]['Dynamic_Model'][0], report[sensor]['Dynamic_Model'][1]) + confBand(flatXD, report[sensor]['StErrD'], report[sensor]['SS_D'], len(flatXD), 1.96), 'r--',label = '95% Confidence Interval Upper Limit ')
        plt.plot(flatXD, vc(flatXD, report[sensor]['Dynamic_Model'][0], report[sensor]['Dynamic_Model'][1]) - confBand(flatXD, report[sensor]['StErrD'], report[sensor]['SS_D'], len(flatXD), 1.96), 'r--',label = '95% Confidence Interval Lower Limit ')
        plt.plot(report[sensor]['xDataT'][0], report[sensor]['yDataT'][0], 'b,', label = 'Trial 1 : Transient')
        plt.plot(report[sensor]['xDataT'][1], report[sensor]['yDataT'][1], 'b,', label = 'Trial 2 : Transient')
        plt.plot(report[sensor]['xDataT'][2], report[sensor]['yDataT'][2], 'b,', label = 'Trial 3 : Transient')
        plt.xlabel('Velocity (m s^-1)')
